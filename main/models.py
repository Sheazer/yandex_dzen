...
class Comment(models.Model):
    # author = models.ForeignKey(User, on_delete=models.CASCADE, related_name="User", verbose_name="Author")
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name="Comment", verbose_name="Post")
    comment = models.TextField(max_length=250, verbose_name="text")
...
class Rating(models.Model):
    post = models.OneToOneField(Post, related_name='ratings', on_delete=models.CASCADE)
